...
<html lang="en">
  ...
  <body>
    ...
    <!-- Header Start -->
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style="width: 100%;">
    ...
    <div class="container-xxl py-5">
      <div class="container">
        ...
        >
          <div class="col-lg-6">
            <p><span class="text-primary me-2">#</span>Pilih Perlombaan</p>
            <h1 class="display-5 mb-0">
              Pilih <span class="text-primary">Perlombaan</span>
            </h1>
          </div>
                ...
                >
                  <div class="position-relative">
                    ...
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">PERLOMBAAN KOMPUTER</p>
                      <h5 class="text-white mb-0">Kuota Lomba : 20</h5>
                    </div>
                  </div>
                </a>
              </div>
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    ...
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">PERLOMBAAN E-SPORT</p>
                      <h5 class="text-white mb-0">Kuota Lomba : 20</h5>
                    </div>
                  </div>
                </a>
              ...
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    ...
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">PERLOMBAAN OFFICE</p>
                      <h5 class="text-white mb-0">Kuota Lomba : 50</h5>
                    </div>
                  </div>
                </a>
              </div>
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    ...
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">PERLOMBAAN OFFICE</p>
                      <h5 class="text-white mb-0">Kuota Lomba : 25</h5>
                    </div>
                  </div>
                </a>
              </div>
              ...
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    ...
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">PERLOMBAAN OFFICE</p>
                      <h5 class="text-white mb-0">Kuota Lomba : 12</h5>
                    </div>
                  </div>
                </a>
              </div>
              <div class="col-12">
                ...
                >
                  <div class="position-relative">
                    ...
                    <div class="animal-text p-4">
                      <p class="text-white small text-uppercase mb-0">PERLOMBAAN OFFICE</p>
                      <h5 class="text-white mb-0">Kuota Lomba : 80</h5>
                    </div>
                  </div>
                </a>
              </div>
      ...
      <div class="container py-5">
        <div class="row g-5">
          <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
            <h1 class="display-6 text-white mb-5">Jadwal Perlombaan</h1>
